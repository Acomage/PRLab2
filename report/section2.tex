...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\textwidth]{../solve/img/graph_spectral_cluster.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\textwidth]{../solve/img/SBM.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=1.0\textwidth]{../solve/img/SBM_nested.png}
